...
<div id="content-wrapper">
    <div class="container-fluid">
        ...
        include "config.php";
        $id=$_GET['id'];
        $query = "SELECT * FROM uploaddetails WHERE `Id`=$id";
        ...
        if(isset($_POST['submit'])){
            ...
            $query="UPDATE uploaddetails SET Name='$name',CarType='$cartype',Price='$price',Speed='$speed',File='$file_name' WHERE Id='$id'";
            $result=mysqli_query($conn,$query);
            if ($result == true) {
                echo "<script>alert('Car Details Updated')+window.open('viewcar.php','_self');</script>";
            } else {
